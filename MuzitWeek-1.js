...
// 1. Write an anonymous function that takes one argument of type number and decides
// if that number is evenly divisble by three or not. If it is, print the number and "is divisible by three" or,
...
3. Create an array of 5 grocery items.Write a
function that returns the first, middle, and last item as a string.

var groceryItems = ["tomato", "potato", "onions", "pepper", "eggs"]
...
// 4. Write a function called alphabetSoup that takes an argument of "str"and return a string with the letters in
// alphabetical order(ie.learn becomes aelnr).Assume numbers and punctuation symbols will not be included in the parameter.
