...
const letterCounter = (str) => {
	return str.split("").filter(letter => letter === "l" || letter === "L").join("").length
}
...
let oddChecker = (arr) => {
	const numsOnly = arr.filter(num => typeof num === "number")
	return numsOnly.filter(num => num % 2 !== 0)
}
