...
console.log(divisibleByThree(24));
...
var groceryList = [ 'milk', 'eggs', 'bread', 'fruit', 'cereal']

const everyOther = () =>{
  var first = groceryList[0]
  var middle = groceryList[2]
  var last = groceryList[4]
  return `${first}, ${middle}, ${last}`
}
console.log(everyOther());


// 4. Write a function called alphabetSoup that takes an argument of "str" and return a string with the letters in alphabetical order
//(ie. learn becomes aelnr). Assume numbers and punctuation symbols will not be included in the parameter.
...
const animalNums = () => {
  ...
  for( let i = 0; i < nums.length; i++){
    numNoun += nums[i] + " " + nouns[i] + ", "
  }
  return numNoun
}
console.log(animalNums());
//8ujnnconsole.log(animalNums());
